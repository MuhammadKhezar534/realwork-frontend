              ...
              <div className="space-y-4">
                {properties.map((property, index) => (
                  <div
                    ...
                    className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200 bg-gradient-to-r from-white to-theme-bgLightSecondary"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="text-xs font-semibold text-black bg-primary-light px-2 py-1 rounded">
